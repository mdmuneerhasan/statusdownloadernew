...
import com.status.statusdownloader.status.Status;
import com.status.statusdownloader.status.StatusAdapter;
...
public class DownloadTrendsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("Downloads(Trends)");
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.container,new TrendsFragment());
                ft.commit();
            }
        });
    ...
    public void loadSong() {
        File file = new File(Environment.getExternalStorageDirectory(), "Status-Downloader/trends/");
