...
public  class MusicFragmentDownload extends Fragment {
    ...
    private static final MusicFragmentDownload music=new MusicFragmentDownload();
    @SuppressLint("ValidFragment")
    private MusicFragmentDownload() {
    }

    public static MusicFragmentDownload getMusicFragment() {
        return music;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("Downloads(Music)");
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.container, MusicFragment.getMusicFragment());
                ft.commit();
                onStart();
            }
        });
    ...
    private void set(final MusicAdapter.Holder holder, final int i) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    popUp2(post.getUrl(),holder.getAdapterPosition());
      }
        });
    ...
    public void loadSong() {
        File file = new File(Environment.getExternalStorageDirectory(), "Status-Downloader/Music");
    ...
    private void load(File[] pictures) {
        try{
            for (File file:pictures) {
                ...
                status.setComment(file.getName());
